...
- **Все кнопки и CTA делай ссылками с реальным адресом (никаких пустых или заглушек в href). Если секция ведет в демо-игру, ставь ссылку на game.html или на внутрішній якір вроде #play і додай відповідний id.**
