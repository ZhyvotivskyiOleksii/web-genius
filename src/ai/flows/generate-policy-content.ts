...
3.  **Текст должен быть профессиональным**, но написан понятным для обычного пользователя языком. Не используй эмодзи или Unicode‑пиктограммы — только текст и, при необходимости, иконки Font Awesome в HTML-версиях.
...
6.  Постоянно подчёркивай, что платформа — соціальна/демо: никаких депозитів, реальних виграшів или азартних платежів. Избегай терминов "jackpot", "bet", "payout", "real money", "bonus", "tournament". Говори про развлечения, пробные спины и навчальний досвід.
